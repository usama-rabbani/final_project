  ...
  <motion.div
    ...
    <div className="flex flex-wrap md:text-left text-center order-first">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        <h2 className="font-extrabold tracking-tight lg:text-xl  text-sm mb-3">
          CATEGORIES
        </h2>
        <nav className="list-none mb-10">
          <li>
            <a className="text-white-600 hover:text-white-800 text-sm">First Link</a>
          </li>
          <li>
            <a className="text-white-600 hover:text-white-800 text-sm">Second Link</a>
          </li>
          <li> 
            <a className="text-white-600 hover:text-white-800 text-sm">Third Link</a>
          </li>
          <li>
            <a className="text-white-600 hover:text-white-800 text-sm">Fourth Link</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
